...
- 추가 시연 자료: 로컬 실행 방법은 원본 저장소의 [HANDOFF.md](HANDOFF.md) "실행 방법" 절 참고
...
- 발표자료: (추가 예정)
- 기획서: (추가 예정)
- 참고한 문서: [HANDOFF.md](HANDOFF.md)(설계 배경·트러블슈팅·전체 원칙), [require.md](require.md)(페르소나 시나리오), [docs/deploy-gce.md](docs/deploy-gce.md)(GCE 배포 절차)
